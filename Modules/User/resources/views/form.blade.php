			...
			<div class="tab-content" id="myTabContent">
				<div class="tab-pane fade show active" id="tabGeneral" role="tabpanel">
					{{-- <div class="fv-row mb-5">
						<div class="image-input" id="kt_image_input_profile" data-kt-image-input="false" style="background-image: url()">
							<div class="image-input-wrapper w-125px h-125px" id="photoPreview" style="background-image: url()"></div>
							...
							<label class="editProfile btn btn-icon btn-circle btn-color-muted btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" data-bs-dismiss="click" title="Change avatar">
								...
								<input type="hidden" name="photo_name" id="photo_name" readonly />
							...
							<span onclick="removePhoto()" class="editProfile btn btn-icon btn-circle btn-color-muted btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="remove" data-bs-toggle="tooltip" data-bs-dismiss="click" title="Remove Profile">
								<i class="bi bi-x fs-2"></i>
							</span>

							<input type="hidden" name="removed_image" id="removed_image" />
					...
					{{-- <div class="fv-row mb-5">
						...
						<div class="mt-2">
							<div class="form-check form-check-inline">
								<input checked class="form-check-input h-20px w-20px" type="radio" name="gender" id="inlineRadio1" value="1">
