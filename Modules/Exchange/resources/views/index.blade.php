<div class="row table_data" data-roleable="false" data-role="Company-Read">
    <div class=" col-12" id="tableExchangeContainer">
                ...
                <div class="row mb-5">
                    <div class="col-12 col-xl d-flex align-items-center justify-content-between ">
                        <div class=" d-flex align-items-center">
                            ...
                            <h3 class="mt-1 mb-5 ms-5">List Exchange</h3>
                        </div>
                    ...
                    <div class="col-12 col-xl-3 col-md-6 col-lg-6 mt-5 my-md-0">
                        <button class="btn btn-primary w-100" data-roleable="true" data-role="updateexchange" onclick="onSync()" id="toggleFormButton"><i class="las la-plus fs-2"></i> Sinkronisasi</button>
                    </div>
                </div>
                <div class="table-responsive border-2 border-top">
                    <table class="table table-striped table-row-bordered align-middle rounded tdFirstCenter" id="tableExchange">
                        <thead>
...
@include('exchange::form')

@include('exchange::javascript')
