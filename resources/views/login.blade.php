...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../../">
		<title>Kazokku Currency Exchange - Admin Login</title>
		<meta name="description" content="The most advanced Bootstrap Admin Theme on Themeforest trusted by 94,000 beginners and professionals. Multi-demo, Dark Mode, RTL support and complete React, Angular, Vue &amp; Laravel versions. Grab your copy now and get life-time updates for free." />
		<meta name="keywords" content="KZK, kazokku" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta charset="utf-8" />
		<meta property="og:locale" content="id_ID" />
		<meta property="og:type" content="login" />
		<meta property="og:title" content="Kazokku Currency Exchange - Admin Login" />
		<meta property="og:url" content="{{ route('index') }}" />
		<meta property="og:site_name" content="Kazokku Currency Exchange - Admin Login" />
		<link rel="canonical" href="{{ route('index') }}" />
		<link rel="shortcut icon" href="{{ asset('assets/media/logos/favicon-kzk.ico') }}" />
		<!--begin::Fonts-->
					...
					<div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
						...
						<div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
							...
							<a href="../../demo1/dist/index.html" class="py-9 mb-5">
								<img alt="Logo" src="{{ asset('assets/media/logos/logo-kazokku.svg') }}" class="h-60px" />
							</a>
							<!--end::Logo-->
							<!--begin::Title-->
							<h1 class="fw-bolder fs-2qx pb-5 pb-md-10">Selamat datang di</h1>
                            <h1 class="fw-bolder fs-2qx pb-5 pb-md-10">Kazokku Currency Exchange</h1>
							<!--end::Title-->
							<!--begin::Description-->
							<p class="fw-bold fs-2" style="color: #986923;">Memfasilitasi kamu yg ingin memantau
							<br />nilai tukar sesuai keinginan kamu</p>
							<!--end::Description-->
						</div>
						<!--end::Content-->
						<!--begin::Illustration-->
						...
						<div class="w-lg-500px p-10 p-lg-15 mx-auto">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="#">
								...
								<div class="text-center mb-10">
									<!--begin::Title-->
									<h1 class="text-dark mb-3">Sign In ke KCE</h1>
									<!--end::Title-->
									<!--begin::Link-->
